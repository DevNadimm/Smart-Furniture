            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "${transaction?.bankName ?? 'Unknown Bank'} - ${transaction?.accountNumber ?? ''}",
                  ...
                  _priceTag(
                    "Deposit",
                    "${CurrencyFormatter.format(int.tryParse(transaction?.deposit ?? '0'))} Tk",
                    AppColors.success,
                  ),
                  const SizedBox(height: 6),
                  _priceTag(
                    "Withdraw",
                    "${CurrencyFormatter.format(int.tryParse(transaction?.withdraw ?? '0'))} Tk",
                    AppColors.warning,
                  ),
                  const SizedBox(height: 6),
                  _priceTag(
                    "Amount",
                    "${CurrencyFormatter.format(int.tryParse(transaction?.amount ?? '0'))} Tk",
