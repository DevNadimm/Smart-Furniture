...
class AdditionalPaymentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final paymentTo = payment?.paymentTo ?? 'N/A';
    final paymentToBn = payment?.paymentToBangla ?? 'N/A';
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "${strings.to}: ${LocalizationService.getText(context, en: paymentTo, bn: paymentToBn)}",
