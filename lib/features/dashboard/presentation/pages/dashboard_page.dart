                    ...
                    Expanded(
                      child: ListView(children: [
                        _ModuleCard(
                          ...
                          onTap: () {
                            Navigator.push(context, EmployeeSalesPage.route(isAdmin: true, branchId: shop.id));
                          },
                        ),
                        ...
                        _ModuleCard(
                          ...
                          backgroundColor: const Color(0xFFF5F3FF),
                          onTap: () {
                            Navigator.push(context, ProductTransferPage.route(branchId: shop.id));
                          },
                        ),
                        const SizedBox(height: 16),
                        _ModuleCard(
                          ...
                          onTap: () {
                            Navigator.push(context, CustomOrderPage.route(isAdmin: true, branchId: shop.id));
                          },
                        ),
                      ]),
                    ),
