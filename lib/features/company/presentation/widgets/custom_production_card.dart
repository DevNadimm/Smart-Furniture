...
class CustomProductionCard extends StatelessWidget {
  final CustomProductionData? production;

  const CustomProductionCard({
    super.key,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildInfoRow(
                          ...
                          label: strings.unit,
                          value:
                          production?.productUnit ?? strings.notAvailable,
                        ),
                      ),
                    ],
                  ),
