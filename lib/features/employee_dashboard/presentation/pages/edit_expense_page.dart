...
class _EditExpensePageState extends State<EditExpensePage> {
  ...
  void initState() {
    super.initState();
    _fetchExpenseHead();
    _expenseDateController.text = widget.expense.transactionDate ?? '';
    _expenseHeadController.text = widget.expense.expense?.head ?? '';
  ...
  void _editExpense() {
    ...
    context.read<EmployeeExpenseBloc>().add(UpdateEmployeeExpenseEvent(widget.expense.id!, expenseData));
