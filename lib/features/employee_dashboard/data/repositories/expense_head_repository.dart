...
class ExpenseHeadRepository {
  static Future<List<ExpenseHeadData>> fetchExpenseHeads() async {
    final api = ApiEndpoints(shop: '');
    final endpoint = api.expenseHeads;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return data.map((e) => ExpenseHeadData.fromJson(e)).toList();
      } else {
        throw Exception(ErrorMessages.fetchExpenseHeadFailed);
      }
    } catch (e) {
      throw Exception(ErrorMessages.fetchExpenseHeadFailed);
    }
